...
open class FPNTextField: UITextField {
    ...
    private var leftViewSize: CGSize {
        let width = flagButtonSize.width + getWidth(text: phoneCodeTextField.text ?? "  ") + ControlWidth(25)
    ...
    private func setup() {
        ...
        phoneCodeTextField.font = UIFont(name: "Muli-Bold", size: ControlWidth(13))
...
//        }
        ...
        PhoneLabel.font = UIFont(name: "Muli", size: ControlWidth(12))
        ...
        view.backgroundColor = #colorLiteral(red: 0.898974049, green: 0.898974049, blue: 0.898974049, alpha: 1)
    ...
    private func setupLeftView() {
        ...
        NSLayoutConstraint(item: flagButton, attribute: .leading, relatedBy: .equal, toItem: leftView, attribute: .leading, multiplier: 1, constant: ControlX(10)).isActive = true
        ...
        NSLayoutConstraint(item: phoneCodeTextField, attribute: .trailing, relatedBy: .equal, toItem: leftView, attribute: .trailing, multiplier: 1, constant: ControlX(-8)).isActive = true
        ...
        NSLayoutConstraint(item: view, attribute: .leading, relatedBy: .equal, toItem: leftView, attribute: .leading, multiplier: 1, constant: ControlX(7)).isActive = true
        NSLayoutConstraint(item: view, attribute: .trailing, relatedBy: .equal, toItem: leftView, attribute: .trailing, multiplier: 1, constant: ControlX(-5)).isActive = true
        NSLayoutConstraint(item: view, attribute: .top, relatedBy: .equal, toItem: flagButton, attribute: .top, multiplier: 1, constant:  0).isActive = true
        NSLayoutConstraint(item: view, attribute: .bottom, relatedBy: .equal, toItem: flagButton, attribute: .bottom, multiplier: 1, constant: 0).isActive = true
        
        view.layer.cornerRadius = ControlWidth(13)
    }
    ...
    open override func leftViewRect(forBounds bounds: CGRect) -> CGRect {
        ...
        let newRect: CGRect = CGRect(x: bounds.minX + ControlX(12), y: bounds.minY, width: width, height: height)
        return newRect
    }
