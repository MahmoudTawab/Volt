...
//                // Setup photo frame
                let photoImageViewFrame = CGRect(origin: CGPoint.zero, size:CGSize(width: UIScreen.main.bounds.width - 10, height: UIScreen.main.bounds.width - 10))
    ...
    func setMaxMinZoomScalesForCurrentBounds() {
        ...
        // Reset position
        photoImageView.frame = CGRect(x: 0, y: 0, width: UIScreen.main.bounds.width - 10, height: UIScreen.main.bounds.width - 10)
