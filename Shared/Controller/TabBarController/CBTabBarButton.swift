...
public class CBTabBarButton: UIControl {
    ...
    private let bgHeight: CGFloat = ControlWidth(45)
    ...
    private func configureSubviews() {
        ...
        tabLabel.font =  UIFont(name: "Muli", size: ControlWidth(14))
        ...
        tabBg.layer.borderColor = #colorLiteral(red: 0.9604254365, green: 0.7348319888, blue: 0.001326194732, alpha: 1)
        tabBg.backgroundColor = .white
        tabBg.layer.borderWidth = ControlWidth(1)
        tabBg.layer.cornerRadius = bgHeight / 2
    ...
    private func fold(animationDuration duration: Double = 0.0) {
        ...
        UIView.transition(with: tabImage, duration: duration, options: [.transitionCrossDissolve], animations: {
            self.tabImage.tintColor = #colorLiteral(red: 0.5495934486, green: 0.5610595345, blue: 0.5610961914, alpha: 1)
        }, completion: nil)
