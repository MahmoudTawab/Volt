...
open class GrowingTextView: UITextView {
    ...
    override open func layoutSubviews() {
        ...
        self.layer.cornerRadius = minHeight / 2.8
    ...
    override open func draw(_ rect: CGRect) {
        ...
        self.textContainerInset = UIEdgeInsets(top: (minHeight / 2) - ControlHeight(13), left: ControlWidth(17), bottom: (minHeight / 2) - ControlHeight(13), right: ControlWidth(17))
        
        if text.isEmpty {
            let placeholderRect = CGRect(x: ControlWidth(20), y: (minHeight / 2) - ControlHeight(13), width: rect.width - ControlWidth(40) , height: ControlHeight(30))
